                            ...
                            <form @submit.prevent>
                                <div class="pl-lg-4">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group has-label">
                                                <label class="form-control-label">Old Passowrd*</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                           <div class="form-group has-label">
                                                <label class="form-control-label">New Passowrd*</label>
                                        ...
                                        <div class="col-md-12">
                                           <div class="form-group has-label">
                                                <label class="form-control-label">New Passowrd Confirm*</label>
